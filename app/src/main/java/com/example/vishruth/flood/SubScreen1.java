...
public class SubScreen1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shared=getSharedPreferences("app1",Context.MODE_PRIVATE);
        getData();
        SharedPreferences.Editor edit=shared.edit();
        edit.putInt("waterlevel1", waterlevel1);
        edit.commit();
    ...
    public void getData() {
        ...
        try {
            URL myurl = new URL("http://techpraja.com/getSensor1.php");
        ...
        try {
            ...
            waterlevel1 = jsonObject.getInt("water_level");
